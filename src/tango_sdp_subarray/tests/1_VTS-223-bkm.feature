...
Feature: SDP Subarray Device
	...
	Scenario Outline: Command succeeds
		Given I have an ONLINE SDPSubarray device
		When obsState is <obs_state_value>
		And I call <command_name>
		Then obsState should be <final_obs_state_value>

		Examples:
		|command_name|obs_state_value|final_obs_state_value|
	...
	Scenario Outline: Commands fail with invalid JSON
		Given I have an ONLINE SDPSubarray device
		When obsState is <obs_state_value>
		And I call <command_name> with invalid JSON
		Then obsState should be FAULT

		Examples:
		|command_name      |obs_state_value|
